...
import com.rud.airlinetickets.databinding.RecommendedArrivalItemBinding
...
class RecommendedArrivalsAdapter(
    ...
    private val diffCallback = object : DiffUtil.ItemCallback<RecommendedArrival>() {
        override fun areItemsTheSame(oldItem: RecommendedArrival, newItem: RecommendedArrival): Boolean {
            return oldItem.id == newItem.id
        }

        override fun areContentsTheSame(oldItem: RecommendedArrival, newItem: RecommendedArrival): Boolean {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecommendedArrivalsViewHolder {
